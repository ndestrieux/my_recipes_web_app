        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (app.enums.LanguageChoice["EN"], "English"),
                            (app.enums.LanguageChoice["FR"], "Français"),
                            (app.enums.LanguageChoice["PL"], "Polski"),
                        ],
                        max_length=32,
                    ),
                ),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    models.CharField(
                        choices=[
                            (app.enums.VoteChoice["UP"], "Up"),
                            (app.enums.VoteChoice["DOWN"], "Down"),
                        ],
                        max_length=16,
                    ),
                ),
